...
class UBCSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class UBCExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(UBCDateTimeConverter converter)
    {
        if(converter==null)
        {
            converter = new UBCStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static UBCDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static UBCDateTimeConverter dateTimeConverter = new UBCStandardDateTimeConverter();

    public UBCExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public UBCExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new UBCMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=UBCHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,UBCExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=UBCHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
