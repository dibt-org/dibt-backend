...
public class UBCKPSPublicSoap
{
    ...
    public UBCKPSPublicSoap(){}

    public UBCKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public UBCKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        UBCExtendedSoapSerializationEnvelope envelope= new UBCExtendedSoapSerializationEnvelope(UBCExtendedSoapSerializationEnvelope.VER11);
